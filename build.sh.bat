...
set OBJEXT=obj
set OUTEXT=dll
set CFLAGS=/nologo /W1 /DWINVER=0x0400 /D_WIN32_WINNT=0x0400 /DWIN32 /DCORRECT_VRAM_READS /D_WINDOWS /D_USRDLL /D_CRT_SECURE_NO_WARNINGS /DMSVC2010_EXPORTS  /D_UNICODE /DUNICODE /utf-8 /GL /O2 /Ob2 /fp:fast /Ot /GF /GT /Oi /MT
set LDFLAGS=/LTCG /OPT:ICF=20
# /GENPROFILE:EXACT
# /USEPROFILE:AGGRESSIVE
set INLINE=__inline
